...
public class Wdv {
    ...
    public void totalimagesTest() {
        ...
        List<WebElement> images1 =
                driver.findElements(By.tagName("//div"));
        System.out.println(images1.size());

        List<WebElement> images33 =
                driver.findElements(By.tagName("//div"));
        System.out.println(images33.size());
    ...
    @Test
    public void totddaldimagesTest() {
    ...
    @Test
    public void totddddddimagesTest() {
        System.out.println(driver.getWindowHandle());
